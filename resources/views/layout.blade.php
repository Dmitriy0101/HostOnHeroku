    ...
    <div class="container container--small">
        <div class="row mx-0">
            <div class="col-2 col-lg-12 px-0 mb-lg-4">
                <div class="row mx-0">
                    <div class="col-2 col-md-1 col-xl-3 px-0">
                        <a href="/" class="logotip">
                            <svg class="logo-theme--black" width="114" height="41">
                                <use href="images/sprite.svg#icon-logo"></use>
                            </svg>
                        </a>
                    </div>

                    <div class="col-9 col-xl-7 mx-0">
                        <div class="header__list">
                            ...
                            <div class="dropdown-phones">
                                <div class="dropdown-phones__header row mx-0">
                                    <a class="dropdown-phones__number" href="tel:+380680000000">+380680000000</a>
                                    <div class="dropdown-phones__toggle">
                                        <button class="button button--theme-number button--scale active">
                                            <svg class="button__togle" width="15" height="6">
                                ...
                                <div class="dropdown-phones__menu visually-hidden">
                                    <a class="dropdown-phones__number" href="tel:+380990000000">+380990000000</a>
                                    <a class="dropdown-phones__number" href="tel:+380960000000">+380960000000</a>
                                </div>
                    ...
                    <div class="col-2 col-xl-2 px-0 ml-auto">
                        <div class="lang">
                            <div class="lang-header">
                                <a href="#" class="lang-header__link active">Ua</a>
                                <a href="#" class="lang-header__link">Ru</a>
                            </div>
                            <div class="user">
                                <button class="user__button">
                                    <a href="#" class="user__text">Войти</a>
                    ...
                    <div class="row align-items-center mx-0">
                        <div class="col-lg-4 col-xl-3 pl-0">
                            <div class="header-content">
                                <div class="header-content__header">
                                    <div class="row justify-content-between mx-0">
                                        <button class="header-content__catalog" data-catalog-menu-button>
                                            <svg class="burger__icon" width="26" height="20">
                                ...
                                <div class="header-catalog visually-hidden" data-catalog-menu>
                                    @foreach( $catalogMenu as $catalogItem)
                                        <a href="/{{$catalogItem['link']}}" class="header-catalog__link">
                                            ...
                                            <svg class="header-catalog__icon icon--path button--scale" width="10"
                                                 height="16">
                        ...
                        <div class="col-3 col-lg-3 col-xl-2  ">
                            <div class="header-actions__wishing">
                                <div class="row row-cols-lg-3 mx-0 mx-lg-0">
                        ...
                        <div class="basket-hovering bsk visually-hidden" data-basket-hovering>
                            <div class="basket-hovering__heading">
                                <div>В корзине
                                    <span class="accent">3 товара</span>
                                </div>
                                <div> На сумму
                                    <span class="accent">30 000 ₴</span>
                                </div>
                            </div>
            ...
            <div class="menu-mobile" data-menu>
                <div class="menu-mobile__content" data-menu-content>
                    <div class="menu-mobile__header">
                        <a href="#" class="menu-mobile__logo button--scale">
                            <svg class="logo-theme--white" width="50" height="31">
                                <use href="images/sprite.svg#icon-logo"></use>
                            </svg>
                        </a>
                        <div class="menu-mobile__user">
                            ...
                            <div class="row mx-0">
                                <a class="col-6">Войти</a>
                                <a class="col-6">Регистрация</a>
                            </div>
                        </div>
                    </div>
                    <div class="menu-mobile__body">
                        ...
                        <nav class="menu-mobile__menu mobile-nav">
                            ...
                            <a class="menu-mobile__link mobile-nav__link" href="#">Политика
                    ...
                    <button type="button" class="menu-mobile__close" data-menu-close data-menu-button>
                        <svg class="menu-mobile__icon icon" width="16" height="16"
...
<div class="cookies">
    <div class="row justify-content-between mx-0">
        <div class="col-12 col-md-9 mb-4 mb-md-0">
            <div class="cookies__text ">Этот сайт использует файлы cookies для более
        ...
        <div class="col-xxl-1">
            <button class="button button-theme--cookies">Согласен</button>
        </div>
    </div>
</div>
        ...
        <div class="basket" data-basket>
            ...
            <div class="basket__body">
                @foreach($basket as $item)
                    <div class="goods">
                        <div class="row mx-0">
                            <button type="button" class="goods__icon">
                                <svg class="icon" width="15" height="15">
                                    <use href="images/sprite.svg#icon-exit"></use>
                                </svg>
                            </button>
                            <div class="col-3 col-lg-2 px-0">
                                <picture class="goods__picture">
                                    ...
                                    <img loading="lazy" class="goods__img" data-src="{{asset($item['image'])}}"
                                    ...
                                    <div class="col-12 px-0 ">
                                        <div class="goods__block">
                                            <div class="goods__left pb-3 pb-lg-0">
                                                <div class="goods__price">Стоимость товара:
                                                    <span class="accent-price">{{$item['price']}} ₴</span>
                                                </div>
                                                <div>
                                                    @foreach($item['services'] as $service)
                                                        <div class="goods__service">Доп. услуга:
                                                            <span class="accent-service">{{$service}}</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
...
<footer class="footer">
    <div class="footer-top">
        <div class="container container--medium">
            <div class="row mx-0">
                <div class="col-12 col-lg-4 col-xxl-3 px-0 pr-lg-3">
                    <div class="footer-top__logo">
                        <a class="footer-top__photo button--scale" href="/">
                            <svg class="logo-theme--white" width="114" height="41">
                                <use href="images/sprite.svg#icon-logo"></use>
                            </svg>
                        </a>
                        ...
                        <div class="footer-top__payment">
                            <div class="row align-items-center mx-0 w-100">
                                ...
                                <div class="payment">
                                    <div class="row mx-0">
                                        <a href="#" class="payment__link" aria-label="visa">
                                            <img loading="lazy" data-src="images/footer/visa.png" alt="" width="53"
                                                 height="30"/>
                                        </a>
                                        <a href="#" class="payment__link" aria-label="mastercard">
                                            <img loading="lazy" data-src="images/footer/master-card.png" alt=""
                                                 width="53" height="30"/>
                                        </a>
                                        <a href="#" class="payment__link" aria-label="maestro">
                                            <img loading="lazy" data-src="images/footer/maestro.png" alt="" width="53"
                                                 height="30"/>
                                        </a>
                                        <a href="#" class="payment__link" aria-label="paypal">
                                            <img loading="lazy" data-src="images/footer/paypal.png" alt="" width="53"
                                                 height="30"/>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="row mx-0">
                            <div class="col-12 col-lg-4 px-0">
                                ...
                                <div class="footer-about__list">
                                    ...
                                    <a href="#" class="footer-about__link ">Аксессуары для планшетов и <br> электронных
                                        книг</a>
    ...
    <div class="footer-bottom">
        <div class="container container--medium px-0">
            <div class="footer-bottom__content">
                <div class="row justify-content-between mx-0">
                        <p class="footer-bottom__copyright">2021 © Wezom Practice</p>
                        <p class="footer-bottom__website">Разработка<span>\\ Wezom</span></p>
                </div>
            </div>
        </div>
    </div>
